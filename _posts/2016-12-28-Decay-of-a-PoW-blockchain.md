...
After the split occurred, miners will continue to solve blocks with the initial difficulty value $\Delta$. In a segment under examination the average time to solve a block will be $$T \cdot \frac{H}{h} \:\:\text{minutes}$$
...
![alt text](https://garkoosha.me/afigure.png)
